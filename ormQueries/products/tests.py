...
class ProductCrudTestCase(TestCase):
    ...
    def test_05_by_rating_range(self): # DONE
    ...
    def test_06_by_rating_and_color(self): # DONE
    ...
    def test_07_by_rating_or_color(self): # DONE
    ...
    def test_10_ordered_by_category_alphabetical_order_and_then_price_decending(self): # DONE
    ...
    def test_11_products_by_manufacturer(self): # DONE
    ...
    def test_12_manufacturer_names_for_query(self): # DONE
    ...
    def test_13_not_in_a_category(self):
        """returns products that are not in a category""" # DONE
        product_crud = ProductCrud.not_in_a_category('Garden')
        product_ids = get_query_ids(product_crud)
        self.assertEquals(product_ids, list(range(1,30)))

    def test_14_limited_not_in_a_category(self): # DONE
    ...
    def test_15_category_manufacturers(self): # DONE
